...
class Curso(models.Model):
    descripcion = models.CharField(
        max_length=100, help_text="Descripcion del Curso", verbose_name="Descripcion del Curso")
...
class RelacionCursoProfesor(models.Model):
    id_profesor = models.ForeignKey(
        Profesor, null=False, blank=False, on_delete=models.CASCADE)
    id_curso = models.ForeignKey(
        Curso, null=False, blank=False, on_delete=models.CASCADE)

    
    def __str__(self):
        return '{}'.format(self.id_profesor)